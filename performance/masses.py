...
class ComponentWeights(object):
    ...
    @staticmethod
    def km_to_mi(km, power=1):
        """ A function to convert kilometers to miles

        :param km: Length in SI kilometer [km]
        :param power: Specify power of unit (1 = km,  = km^2, etc) inverse conversions are possible with negative powers
        :return: Length in Imperial miles
        """
        return km * (0.6214 ** power)
