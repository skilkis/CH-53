...
__plot__ = (True if __name__ == '__main__' else False)
...
print('Question 5-4: ACT Ideal Hover Power = %1.2f [W]' % P_i_ACT)

#  Question 5-5: Calculate the hover power in ACT theory
P_hov_ACT = P_i_ACT / FM
PL_ACT = W / P_hov_ACT
print('Question 5-5: ACT Hover Power = %1.2f [W]' % P_hov_ACT)
print('Hover ACT Power Loading = %1.2f [N/W]' % PL_ACT)
...
PL_BEM = W / P_hov_BEM
print('Question 5-6: Hover BEM Power = %1.2f [W]' % P_hov_BEM)
print('Hover BEM Power Loading = %1.2f [N/W]' % PL_BEM)
...
print('Question 5-7: The Power In Forward Flight at V = %1.2f [m/s] is  %1.4f [W]' % (V, P_t0))
print('Question 5-8: The Tail Rotor Power In Forward Flight at V = %1.2f [m/s] is %1.4f [W]' % (V, (P_i_tr_v+P_p_tr_v)))

C_T = W / (rho * pi * (R ** 2) * ((omega * R) ** 2))

C_L_bar = (6.6 * C_T) / psi

print('\nTrust Coefficient is %1.4f' % C_T)
print('Medium Lift Coefficient is %1.4f' % C_L_bar)
